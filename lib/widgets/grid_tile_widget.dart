...
class GridTileWidget extends StatefulWidget {
  ...
  GridTileWidget({Key? key,required this.spanCount,required this.callback,required this.listOfItems}) : super(key: key);
...
class _GridTileWidgetState extends State<GridTileWidget> {
  ...
  Widget build(BuildContext context) {
    return GridView.builder(
      ...
      gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
          crossAxisCount: widget.spanCount!,childAspectRatio: widget.spanCount == 2 ? 5 : 3),
  ...
  Widget buildGrid(int index) {
    ...
    return GestureDetector(
      ...
      child: Padding(
        padding: EdgeInsets.only(right: 4.w,top: widget.spanCount == 2 ? 0.w :4.w),
        child: Container(
