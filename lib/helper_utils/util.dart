...
class Utils{
  ...
  static void updateDialog(context, YarnSpecification? yarnSpecification,
    ...
    specification.priceUnit!.replaceAll(RegExp(r'[^0-9]'), ''):yarnSpecification!.priceUnit!.replaceAll(RegExp(r'[^0-9]'), '');
    controllerAvailQ.text = specification != null ? specification.available ?? "":yarnSpecification!.available ?? "";
    createRequestModel.ys_id = specification != null ? specification.spcId.toString():yarnSpecification!.ysId.toString();
    ...
    AppDbInstance.getDeliveryPeriod().then((value1) {
      var period = specification != null ? specification.deliveryPeriod :yarnSpecification!.deliveryPeriod;
      /*Logger().e(period.toString());
      Logger().e(value1.toString());*/
      deliveryPeriod = value1
          .where((element) =>
      element.dprName == period)
          .first;
      createRequestModel.fbp_delivery_period_idfk = deliveryPeriod.dprId.toString();
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: ElevatedButtonWithoutIcon(
                              callback: () {
                                showGenericDialog("Alert", 'Are you sure, you want to update specification?', context,
                                      ...
                                      ApiService.createSpecification(
                                        ...
                                        if (value.status) {
                                          ...
                                          if (value.responseCode == 205) {
                                            showGenericDialog("Alert", value.message, context,
                                                StylishDialogType.WARNING, "My Products", () {
                                                  Navigator.pop(context);
