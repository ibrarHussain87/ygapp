...
StockLotSpecificationResponse stockLotSpecificationResponseFromJson(String str) => StockLotSpecificationResponse.fromJson(json.decode(str));
String stockLotSpecificationResponseToJson(StockLotSpecificationResponse data) => json.encode(data.toJson());
class StockLotSpecificationResponse {
  ...
  StockLotSpecificationResponse.fromJson(dynamic json) {
    ...
    _data = json['data'] != null ? StockLotData.fromJson(json['data']) : null;
  ...
  StockLotData? _data;
  String? _message;
StockLotSpecificationResponse copyWith({  bool? status,
  int? responseCode,
  StockLotData? data,
  String? message,
}) => StockLotSpecificationResponse(  status: status ?? _status,
...
StockLotData dataFromJson(String str) => StockLotData.fromJson(json.decode(str));
...
StockLotData copyWith({  List<StockLotSpecification>? specification,
}) => StockLotData(  specification: specification ?? _specification,
);
...
StockLotSpecification specificationFromJson(String str) => StockLotSpecification.fromJson(json.decode(str));
...
class StockLotSpecification {
  ...
  String? _date;
StockLotSpecification copyWith({  int? id,
  String? userId,
  String? company,
  String? stocklotCategoryId,
  String? category,
  ...
  List<dynamic>? pictures,
  String? date,
}) => StockLotSpecification(  id: id ?? _id,
...
SpecDetails specDetailsFromJson(String str) => SpecDetails.fromJson(json.decode(str));
...
class SpecDetails {
  ...
  String? _origin;
  String? _description;
SpecDetails copyWith({  String? stocklotSubCategoryId,
  String? subCategory,
  String? quantity,
  dynamic unit,
  String? price,
  ...
  String? origin,
  String? description,
}) => SpecDetails(  stocklotSubCategoryId: stocklotSubCategoryId ?? _stocklotSubCategoryId,
