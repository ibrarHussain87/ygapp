...
class StockLotListItem extends StatefulWidget {
  ...
  const StockLotListItem(
      {Key? key, required this.specification, this.showCount,
        this.showDetailsButton=false,this.bidData})
      : super(key: key);
    ...
    return Padding(
      ...
      child: Material(
          ...
          shape: RoundedRectangleBorder(
            ...
            borderRadius: widget.showDetailsButton == false ? BorderRadius.circular(10) :
            ...
            children: [
                ...
                child: Column(
                  children: [
                                      ...
                                      child: GestureDetector(
                                          onTap: () {
                                            openDetailsScreen(context,
                                                specObj: widget.bidData!.specification,
                                                isFromBid: true);
                                          },
                                          child: SizedBox(
                                            width: 80,
                    ...
                    Padding(
                      ...
                      child: Utils.buildContainer(widget.bidData!),
                    ) : Container()
                  ],
                ),
              ),
              Visibility(
                visible: Ui.showHide(widget.specification.isFeatured) && widget.showDetailsButton == false,
              ...
              Positioned(
                ...
                child: Column(
                  ...
                  children: [
                    Visibility(
                      visible: Ui.showHide(widget.specification.isFeatured) && widget.showDetailsButton == true,
                      maintainSize: true,
                      maintainState: true,
                      maintainAnimation: true,
                      child: Container(
