...
warpSheet(
    ...
    Function callback,
    String familyId,
    List<FabricQuality> qualityList,
    List<FabricPly> plyList) {
  String? selectedWarpPlyId;
  String? selectedWarpQualityId;
  if (fabricCreateRequestModel!.fs_warp_ply_idfk != null) {
    selectedWarpPlyId = fabricCreateRequestModel.fs_warp_ply_idfk;
  }else if(fabricCreateRequestModel.fs_wrap_quality_idfk != null){
    selectedWarpQualityId = fabricCreateRequestModel.fs_wrap_quality_idfk;
  }
...
//
                                  ...
                                  YgTextFormFieldWithRangeNonDecimal(
                                      ...
                                      value: fabricCreateRequestModel
                                          .fs_warp_count,
                                      label: 'Warp Count',
                                      // onChanged:(value) => globalFormKey.currentState!.reset(),
                                      minMax: fabricSetting.warpCountMinMax ??
                                          'n/a',
                                      maxLength: 3,
                                      autoFocus: true,
                                      onSaved: (input) {
                                        fabricCreateRequestModel.fs_warp_count =
                                            input;
                                      }),
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              SingleSelectTileWidget(
                                selectedIndex: fabricCreateRequestModel
                                            .fs_warp_ply_idfk ==
                                        null
                                    ? -1
                                    : plyList
                      ...
                      Row(
                        children: [
                          Visibility(
                            visible:
                                Ui.showHide(fabricSetting.showNoOfEndsWarp),
                            child: Expanded(
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
...
//                                                child: const TitleSmallTextWidget(title: 'No of Ends' + '*')),
                                  ...
                                  YgTextFormFieldWithRangeNonDecimal(
                                      ...
                                      // onChanged:(value) => globalFormKey.currentState!.reset(),
                                      minMax:
                                          fabricSetting.noOfEndsWarpMinMax ??
                                              'n/a',
                                      onSaved: (input) {
                                        fabricCreateRequestModel
                                            .fs_no_of_ends_warp = input;
                                      })
                                ],
                              ),
                            ),
                          ...
                          children: [
                            ...
                            SingleSelectTileWidget(
                              ...
                              callback: (FabricQuality value) {
                                selectedWarpQualityId =
                                    value.fabricQualityId.toString();
                                fabricCreateRequestModel
                                    .fs_wrap_quality_idfk =
                        ...
                        return TextButton(
                            ...
                            onPressed: () {
                              if (validationAllPage(
                                  fabricSetting, selectedWarpPlyId,selectedWarpQualityId)) {
                                FocusScope.of(context).unfocus();
                                fabricCreateRequestModel.fs_warp_ply_idfk =
                                    selectedWarpPlyId;
                                fabricCreateRequestModel.fs_wrap_quality_idfk =
                                    selectedWarpQualityId;
                                callback.call();
...
bool validationAllPage(FabricSetting fabricSetting, String? selectedPlyId, String? selectedWarpQualityId) {
  if (validateAndSaveWrap()) {
    if ((selectedPlyId == null || selectedPlyId == '') &&
      ...
      return false;
    } else if (selectedWarpQualityId == null || selectedWarpQualityId == '') {
      Fluttertoast.showToast(msg: 'Please Select Warp Quality');
      return false;
    } else {
      return true;
    }
