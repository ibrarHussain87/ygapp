                                          ...
                                          callback: (FabricSalvedge value) {
                                            _createRequestModel!
                                                ...
                                                value.fabricSalvedgeId
                                                    .toString();
                                            if (value.fabricSalvedgeId ==
                                                2 /*Tuckin*/) {
                                              _notifierShowTuckingWidth.value =
                                              true;
                                            } else {
                                              _notifierShowTuckingWidth.value =
                                              false;
...
//                                                title: 'GSM')),
                ...
                Padding(
                  ...
                  child: SizedBox(
                    ...
                    child: ElevatedButtonWithIcon(
                      ...
                      color: btnColorLogin,
                      btnText:
                      widget.businessArea == offeringType ? "Next" : submit,
                    ),
                  ),
                ),
              ],
  ...
  void submitData(BuildContext context) {
    if (_createRequestModel != null) {
      ...
      ApiService()
          .createFabricSpecification(_createRequestModel!,
    ...
    if (validateAndSave()) {
      ...
      if (_createRequestModel!.fs_formation == null) {
        Ui.showSnackBar(context,
            'Please add ${postFabricProvider.selectedFabricFamily
                .toString()} formation.');
        return false;
      ...
      /*else if (_createRequestModel!.fs_blend_idfk == null &&
        ...
        return false;
          ...
          _createRequestModel!.fs_color!.isEmpty) &&
          _showDyingMethod) {
  ...
  String? getWarpList(FabricCreateRequestModel createRequestModel) {
    ...
    if (_createRequestModel!.fs_wrap_quality_idfk != null) {
      list.add(_qualityList
          .where((element) =>
      element.fabricQualityId.toString() ==
          createRequestModel.fs_wrap_quality_idfk)
          .toList()
          .first
          .fabricQualityName);
    }
  ...
  String? getWeftList(FabricCreateRequestModel createRequestModel) {
    ...
    if (_createRequestModel!.fs_weft_quality_idfk != null) {
      list.add(_qualityList
          .where((element) =>
      element.fabricQualityId.toString() ==
          createRequestModel.fs_weft_quality_idfk)
          .toList()
          .first
          .fabricQualityName);
    }
