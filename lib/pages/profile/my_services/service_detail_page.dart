...
class ServiceDetailPage extends StatefulWidget {
  final ServicesModel servicesDetails;
              ...
              children: [
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        Text(widget.servicesDetails.complaintNo.toString() ,style:TextStyle(fontSize:12.sp,fontWeight: FontWeight.w500,color: Colors.grey.shade500)),
                      ],
                    ),
                ...
                Row(
                  ...
                  children: [
                    Row(
                      children: [
                        Text("District:",style:TextStyle(fontSize:12.sp,fontWeight: FontWeight.w600,color: Colors.black87)),
                        const SizedBox(width: 3,),
                        Text("OKARA" ,style:TextStyle(fontSize:12.sp,fontWeight: FontWeight.w500,color: Colors.grey.shade500)),
                      ],
                    ),
                    ...
                    Row(
                      ...
                      children: [
                        Text("Tehsil:",textAlign:TextAlign.start,style:TextStyle(fontSize:12.sp,fontWeight: FontWeight.w600,color: Colors.black87)),
                        const SizedBox(width: 3,),
                        Text("OKARA",textAlign: TextAlign.center,overflow: TextOverflow.fade,style:TextStyle(
                ...
                Row(
                  ...
                  children: [
                    ...
                    const SizedBox(width: 3,),
                    Expanded(child: Text(widget.servicesDetails.type.toString() ,style:TextStyle(fontSize:12.sp,fontWeight: FontWeight.w500,color: Colors.grey.shade500))),
                  ],
                ),
                Row(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    ...
                    const SizedBox(width: 3,),
                    Expanded(child: Text(widget.servicesDetails.subType.toString(),textAlign: TextAlign.start ,style:TextStyle(fontSize:12.sp,fontWeight: FontWeight.w500,color: Colors.grey.shade500))),
                  ],
                ),
                Row(
                  crossAxisAlignment: CrossAxisAlignment.start,
                    ...
                    Expanded(
                      ...
                      child: Row(
                        children: [
                          ...
                          const SizedBox(width: 3,),
                          Text(widget.servicesDetails.date.toString() ,style:TextStyle(fontSize:12.sp,fontWeight: FontWeight.w500,color: Colors.grey.shade500)),
                        ],
                      ),
                    ),
