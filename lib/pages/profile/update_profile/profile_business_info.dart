...
class ProfileBusinessInfoPageState extends State<ProfileBusinessInfoPage>
  ...
  final _businessAreaTypeAheadController = TextEditingController();
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      ...
      _updateBusinessRequestModel =
          _profileInfoProvider.updateBusinessRequestModel;
      _businessAreaTypeAheadController.text =
          _profileInfoProvider.businessInfo?.name != null
              ? _profileInfoProvider.businessInfo!.name.toString()
              : '';
    });
  }
...
//              key: scaffoldKey,
                  ...
                  child: Center(
                    child: Builder(builder: (BuildContext context2) {
                      return (!_profileInfoProvider.isLoading)
                          ? buildBusinessDataColumn(
                              _profileInfoProvider.businessInfo, context2)
                          : Container();
                    }),
                  ),
                ),
  ...
  Column buildBusinessDataColumn(
      BusinessInfo? snapshot, BuildContext context2) {
    return Column(
      children: [
        Padding(
          padding:
...
//                  controller: ntnController,
                  ...
                  // },
                  decoration:
                      textFieldDecoration('', "GST (NTN Number)", false)),
            ],
          ),
        ),
        Padding(
            ...
            children: [
              TypeAheadFormField(
                  textFieldConfiguration: TextFieldConfiguration(
                    ...
                    decoration: textFieldDecoration('', "Company Name", true),
                  ),
                  noItemsFoundBuilder: (BuildContext context) {
                    return const Text('');
                  },
                  suggestionsCallback: (pattern) {
                    return _profileInfoProvider.companiesList
                        .where((Companies x) =>
                  ...
                  onSuggestionSelected: (Companies suggestion) {
                    ...
                    _updateBusinessRequestModel.company =
                        suggestion.name.toString();
                    _updateBusinessRequestModel.companyName =
                        suggestion.name.toString();
                    _updateBusinessRequestModel.name =
                        suggestion.name.toString();
                    _updateBusinessRequestModel.companyId =
          ...
          child: Column(
            ...
            children: [
              DropdownButtonFormField<GenericCategories>(
                ...
                isExpanded: true,
                iconSize: 21,
                value: _profileInfoProvider.categoriesList
                    .where((element) =>
                        element.catId ==
                        _profileInfoProvider.userCategory.first.catId)
                    .toList()
                    .first,
                ...
                onChanged: (newValue) {
                  _updateBusinessRequestModel.ubi_business_area_idfk =
...
//              controller: tradeController,
                  ...
                  //   return null;
                  // },
                  decoration: textFieldDecoration('', "Trade Mark", false)),
            ],
          ),
        ),
        Padding(
...
//                  controller: roleController,
                  ...
                  // },
                  decoration:
                      textFieldDecoration('', "Employment Role", false)),
            ],
          ),
        ),
        Padding(
          ...
          child: Column(
            ...
            children: [
              DropdownButtonFormField<Designations?>(
                decoration: textFieldDecoration('Select', "Designation", false),
                isDense: true,
                hint: Text(
                  "Select Designation",
                  style: TextStyle(
                ...
                onChanged: (Designations? value) {
                  ...
                  _updateBusinessRequestModel.designation_idfk =
...
//              controller: addressController,
                  ...
                  // },
                  decoration:
                      textFieldDecoration('', "Company Address", false)),
            ],
          ),
        ),
        Padding(
                      ...
                      Expanded(
                          ...
                          child: Text(
                              _profileInfoProvider
                                      .selectedCompanyCountry?.conName ??
                                  "Select Country",
            ...
            children: [
              DropdownButtonFormField(
                ...
                onChanged: (Cities? value) {
                  ...
                  _updateBusinessRequestModel.city = value?.cityId.toString();
                },
...
//                   },
                  decoration:
                      textFieldDecoration('', "Company Zip Code", false)),
            ],
          ),
        ),
        Padding(
...
//                  controller: webController,
                  ...
                  //   return null;
                  // },
                  decoration: textFieldDecoration('', "Website", false)),
            ],
          ),
        ),
        Padding(
                ...
                return TextButton(
                    ...
                    onPressed: () {
                      if (validateAndSaveBusinessInfo()) {
                        FocusScope.of(context).requestFocus(FocusNode());
                        var contain = _profileInfoProvider.companiesList.where(
                            (element) =>
                                element.name ==
                                _updateBusinessRequestModel.company);
                        if (contain.isEmpty) {
  ...
  bool validateAndSaveBusinessInfo() {
    ...
    if (_updateBusinessRequestModel.countryId == null ||
        _updateBusinessRequestModel.countryId == "") {
  ...
  void _updateBusinessCall(BuildContext context1) {
    check().then((value) {
      if (value) {
        ...
        ApiService()
            .updateBusinessInfo(_updateBusinessRequestModel)
            .then((value) {
