...
class _MainPageState extends State<MainPage> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance?.addPostFrameCallback((_) {
      if(!_syncProvider.isDataSynced) DialogBuilder(context).showSyncDialog();
      _syncProvider.syncAppData();
      if (_syncProvider.isDataSynced) DialogBuilder(context).hideDialog();
